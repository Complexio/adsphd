...
given_settings = {
  ...
  'cleanext':         ['.tdo', '.fls', '.toc', '.aux', '.log', '.bbl', '.blg',
                       '.log', '.lof', '.lot', '.ilg', '.out', '.glo', '.gls',
                       '.nlo', '.nls', '.brf', '.ist', '.glg', '.synctexgz',
                       '.tgz', '.idx', '.ind', '-blx.bib', '.fdb_latexmk',
                       '.synctex.gz', '.run.xml', '.bcf', '.glsdefs', '.xdy']
}
...
def newchapter():
    ...
    while validchaptername.match(chaptername) is None:
